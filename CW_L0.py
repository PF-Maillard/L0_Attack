...
class CarliniL0():
    ...
    def doit(self, oimgs, labs, starts, valid, CONST, device):
        ...
        tlab = torch.nn.functional.one_hot(tlab, num_classes= self.num_labels)
        ...
        while CONST < self.LARGEST_CONST:
            ...
            for step in range(self.MAX_ITERATIONS):
                ...
                #print((1-tlab)*output - (tlab*10000), other)
                if self.TARGETED:
    ...
    def attack(self, imgs, targets, device):
        """
        ...
        for i,(img,target) in enumerate(zip(imgs, targets)):
            ...
            r = torch.cat((r, self.attack_single(img, target, device)), dim=0)
        return r

    def attack_single(self, img, target, device):
        """
        ...
        while True:
            ...
            print("Forced equal:",torch.sum(1-valid), "Equal count:",equal_count,torch.sum(valid), valid.shape)
